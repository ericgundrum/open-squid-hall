...
Open Squid Hall is a virtual ‘exhibits hall’ for a science fiction convention. It runs in a web browser using [Babylon.js](https://www.babylonjs.com) and [Colyseus](https://colyseus.io). It uses the [SquidSpace](https://github.com/jackwilliambell/SquidSpace.js) tools to generate the virtual space. SquidSpace makes it easier to create high-quality virtual interactive spaces that are accessible to anyone with a web browser. 

Squid Hall was initially created for CoNZealand, the 2020 World Science Fiction Convention. It featured an art show, dealer tables, and displays about the Guest of Honour. The layout and design was based on the actual TSB Arena in Wellington, New Zealand. Wellington is home of the Colossal Squid, hence the name. 

Open Squid Hall is an open-source version of Squid Hall. The content is public domain or used with permission. 
...
* .glTF (and the binary version .glb)
